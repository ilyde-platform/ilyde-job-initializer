...
from protobuffers import project_pb2 as project__pb2
...
class ProjectServicesStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Delete = channel.unary_unary(
        ...
        request_serializer=project__pb2.ID.SerializeToString,
        response_deserializer=project__pb2.OperationStatus.FromString,
        )
    self.Search = channel.unary_unary(
        '/project.ProjectServices/Search',
        request_serializer=project__pb2.SearchRequest.SerializeToString,
        response_deserializer=project__pb2.SearchResponse.FromString,
        )
...
def add_ProjectServicesServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'Delete': grpc.unary_unary_rpc_method_handler(
          servicer.Delete,
          request_deserializer=project__pb2.ID.FromString,
          response_serializer=project__pb2.OperationStatus.SerializeToString,
      ),
      'Search': grpc.unary_unary_rpc_method_handler(
          servicer.Search,
          request_deserializer=project__pb2.SearchRequest.FromString,
          response_serializer=project__pb2.SearchResponse.SerializeToString,
      ),
